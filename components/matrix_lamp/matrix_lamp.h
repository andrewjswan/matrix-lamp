...
static const char *const MATRIX_LAMP_VERSION = "2026.7.5";
...
class MatrixLamp_Icon {
 ...
 public:
  MatrixLamp_Icon(const uint8_t *data_start, uint32_t width, uint32_t height, uint32_t animation_frame_count,
                  esphome::image::ImageType type, std::string icon_name, bool revers, uint16_t frame_duration,
                  esphome::image::Transparency transparency);
  ~MatrixLamp_Icon() {
